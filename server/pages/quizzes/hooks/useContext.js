...
/* harmony import */ var _consts_quizzes_hooks_useContext_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1412);
...
const quizTopic = "useContext";
const UseContextQuiz = ({ quizData: quizData1  })=>{
...
async function getStaticProps() {
    return {
        props: {
            quizData: _consts_quizzes_hooks_useContext_json__WEBPACK_IMPORTED_MODULE_3__,
            title: `${quizTopic} React Hook Quiz`,
            description: `Quiz on react most used ${quizTopic} hook.`
        }
    };
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(UseContextQuiz));
...
var __webpack_exports__ = __webpack_require__.X(0, [895,664,675,891,435,412], () => (__webpack_exec__(2507)));
